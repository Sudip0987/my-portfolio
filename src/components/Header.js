...
function Header() {
  ...
  <a 
    href="#home" 
    className="hover:text-yellow-400 px-4 py-2 rounded transform transition duration-200 ease-in-out hover:scale-110 inline-block" 
  ...
  >
    ...
    className="hover:text-yellow-400 px-4 py-2 rounded transform transition duration-200 ease-in-out hover:scale-110 inline-block" 
    onClick={() => setIsOpen(false)}>About</a></li>
            <li><a href="#projects"     className="hover:text-yellow-400 px-4 py-2 rounded transform transition duration-200 ease-in-out hover:scale-110 inline-block" 
 onClick={() => setIsOpen(false)}>Projects</a></li>
            <li><a href="#contact"     className="hover:text-yellow-400 px-4 py-2 rounded transform transition duration-200 ease-in-out hover:scale-110 inline-block" 
